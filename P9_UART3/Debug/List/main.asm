...
_0x0:
	.DB  0x41,0x56,0x52,0x3A,0x20,0x25,0x64,0x20
	.DB  0x0
_0x2000000:
...
_main:
; .FSTART _main
; 0000 001C unsigned char str[16];
; 0000 001D int a = 0;
; 0000 001E 
; 0000 001F usart_init();
	SBIW R28,16
;	str -> Y+0
;	a -> R16,R17
	__GETWRN 16,17,0
...
_0x3:
; 0000 0022     {
; 0000 0023       //scanf("%s",str);
; 0000 0024       //  puts(str);
; 0000 0025      //printf("AVR");
; 0000 0026      //delay_ms(1000);
; 0000 0027 
; 0000 0028 
; 0000 0029        printf("AVR: %d " ,a);
	__POINTW1FN _0x0,0
	ST   -Y,R31
	ST   -Y,R30
	MOVW R30,R16
